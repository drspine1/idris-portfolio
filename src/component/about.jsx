...
<div className="upper-me flex flex-col-reverse md:flex-row gap-[5%] text-left">
  ...
  <div className="about-content flex-[60%]">
      ...
      className="text-lg mb-8 text-[#ebe8e8]">
        Hi there! I'm <span className="font-bold text-[#f39f5a] text-xl">idris mutolib</span >, a passionate Junior Frontend Developer with a unique journey into the world of technology. With a background in Science Laboratory and Technology, I've always been drawn to problem-solving and innovation. After earning my ND in Science Laboratory and Technology, I embarked on a self-study journey in web development, fueled by a desire to create meaningful digital experiences.
      </motion.p>
      <motion.p 
      ...
      className="text-lg mb-4 text-[#ebe8e8]">
        Over the past two years, I've immersed myself in the world of frontend development, honing my skills through self-directed learning and hands-on project work. Through building personal projects, I've gained invaluable experience in <span className='text-[#f39f5a] italic'>Html, Css, Jscript, Taiwind, React and Redux Toolkit</span>, crafting intuitive user interfaces and bringing creative ideas to life.
      </motion.p>
