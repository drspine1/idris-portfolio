  ...
  <div>
    ...
    <p class="text-base text-[#c1e8ff] leading-tight">Web Developer</p>
      ...
      <ul className="mr-6  hidden sm:block">
       ...
       <li className="inline-block mx-2 md:mx-8 cursor-pointer"><Link activeClass={active}  to="service" offset={-110}  spy={true} smooth={true} duration={500} className="text-lg md:text-xl font-medium uppercase">services</Link></li>
       ...
       <li className="inline-block mx-2 md:mx-8 cursor-pointer"><Link activeClass={active}  to="project" spy={true} smooth={true} offset={-110} duration={500} className="text-lg md:text-xl font-medium uppercase">project</Link></li>
      ...
      <div className="toggle-btn block sm:hidden">
        <button className="text-[white] text-2xl font-extrabold " onClick={()=>setToggle(!toggle)}>
          {
